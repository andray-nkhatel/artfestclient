...
const login = async () => {
  ...
  try {
    ...
    // Check if user has Admin or Official/Judge role
    if (userRoles.includes('Admin')) {
      redirectPath = '/app/admin-dashboard';
    } else if (userRoles.includes('Official') || userRoles.includes('Judge')) {
      redirectPath = '/app/judge-dashboard';
    } else {
      redirectPath = '/app/';
    }
    ...
    <div class="flex flex-col items-center justify-center">
      ...
      <div class="w-full py-20 px-8 sm:px-20" style="border-radius: 53px">
        ...
        <div class="text-center mb-8">
          ...
          <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">ARTSFEST</div>
